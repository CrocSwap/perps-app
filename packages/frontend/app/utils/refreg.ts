...
type BuildCompleteConversionIxParams = {
...
export async function buildCompleteConversionIx(
    params: BuildCompleteConversionIxParams,
    ...
    try {
        ...
        if (!trackingIdRaw) {
            console.info('[refreg] Skipping conversion: tracking_id missing');
            return null;
        }
        ...
        if (!trackingIdBytes || trackingIdBytes.length !== 32) {
            console.info('[refreg] Skipping conversion: invalid tracking_id');
            return null;
        }
        ...
        console.info('[refreg] Skipping conversion due to error:', error);
        return null;
    }
}
